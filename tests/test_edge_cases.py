"""Performance and edge case tests for QKerasLayer."""
...
def test_different_layer_counts(layers):
    """Test QKerasLayer with different numbers of layers."""
    try:
        from pennylane_keras_layer import QKerasLayer
        
        layer = QKerasLayer(layers=layers, num_wires=1)
...
def test_different_wire_counts(num_wires):
    """Test QKerasLayer with different numbers of wires."""
    try:
        from pennylane_keras_layer import QKerasLayer
        
        layer = QKerasLayer(layers=2, num_wires=num_wires)
...
def test_different_scaling_factors(scaling):
    """Test QKerasLayer with different scaling factors."""
    try:
        import keras
        from pennylane_keras_layer import QKerasLayer
...
def test_different_backends(backend):
    """Test QKerasLayer with different quantum backends."""
    try:
        from pennylane_keras_layer import QKerasLayer
        
        layer = QKerasLayer(layers=2, circ_backend=backend, num_wires=1)
...
def test_extreme_input_values():
    """Test QKerasLayer with extreme input values."""
    try:
        import keras
        from pennylane_keras_layer import QKerasLayer
...
def test_zero_input():
    """Test QKerasLayer with zero input."""
    try:
        import keras
        from pennylane_keras_layer import QKerasLayer
...
def test_reproducibility_with_seed():
    ...
    try:
        ...
        q_layer1 = QKerasLayer(layers=2, num_wires=1, circ_backend="default.qubit")
        out1 = q_layer1(inp1)
        ...
        q_layer2 = QKerasLayer(layers=2, num_wires=1, circ_backend="default.qubit")
        out2 = q_layer2(inp2)
...
def test_layer_naming():
    ...
    try:
        ...
        layer1 = QKerasLayer(layers=2, num_wires=1, name="quantum_layer_1")
        assert layer1.name == "quantum_layer_1"
        
        layer2 = QKerasLayer(layers=2, num_wires=1, name="quantum_layer_2")
